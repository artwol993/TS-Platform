...
function Offer({ id, companyName, loadingCountry, loadingCity, loadingDate, unloadingCountry, unloadingPostcode, unloadingDate, shipmentWeight, shipmentLength, userName, userMail }) {
