            ...
            <form onSubmit={handleNewLoad}>
                <div className="form-container">
                    ...
                    <div className="form-box">
                        ...
                        <input type="number" className="form-element" name="loadingPostcode" placeholder="Kod pocztowy z" value={loadingPostcode} onChange={(e) => setLoadingPostcode(e.target.value)} />
