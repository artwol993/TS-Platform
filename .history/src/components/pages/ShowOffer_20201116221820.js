    ...
    return (
        <div className='showOffer-section'>
            ...
            <div className='showOffer-container'>
                ...
                {offers.map(el => (
                    <div className='showOffer' key={el.id}>{el.loadingCountry}</div>
                ))}
                {offers.map(el => (
                ...
                {offers.map(el => (
                    <div key={el.id}>{el.shipmentWeight}</div>
                ))}
                {offers.map(el => (
                    <div key={el.id}>{el.shipmentLength}</div>
                ))}
                {offers.map(el => (
                    <div key={el.id}>{el.companyName}</div>
                ))}
                {offers.map(el => (
                    <div key={el.id}>{el.userName}</div>
                ))}
                {offers.map(el => (
                    <div key={el.id}>{el.userMail}</div>
                ))}
