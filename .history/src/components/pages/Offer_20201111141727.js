...
function Offer({ id, companyName, loadingCountry, loadingCity, loadingDate, unloadingCountry, unloadingPo, unloadingDate, shipmentWeight, shipmentLength, userName, userMail }) {
