    ...
    return (
        <li className={"list"} id={id}>
            <div className="offer_box">
                        ...
                        <p className={"function Offer({ id, companyName, loadingCountry, loadingPostCode, loadingDate, unloadingCountry, unloadingPostcode, unloadingDate, shipmentWeight, shipmentLength, userName, userMail }) {
"}>{unloadingPostCode} </p>
