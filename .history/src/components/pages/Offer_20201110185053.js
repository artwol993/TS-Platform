                ...
                <div className={"offer_single"}>
                    ...
                    <div className={"offer_info"}>
                        <div className={"who_and_when"}>
                            ...
                            <p>{function Offer({ id, companyName, loadingCountry, loadingPostCode, loadinDate, unloadingCountry, unloadingPostcode, unloadingDate, shipmentWeight, shipmentLength, userName, userMail }) {
}</p>
                        </div>
        </li>
    )
